<header class="sticky top-0 antialiased">
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800 ">
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                {{-- Side Bar Toggle --}}
                <button aria-expanded="true" aria-controls="sidebar" data-drawer-target="drawer-navigation"
                ...
                {{-- Logo --}}
                <a href="{{ route('PMS.frontdesk') }}" class="flex mr-4">
                    <img src={{ asset('assets/images/W.jpg') }} class="mr-3 h-8" alt="FlowBite Logo" />
                    <span
