...
@if (Route::is('frontdesk.stafflist'))
    <div id="addStaffModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Add new staff</h3>
                    <form id="addStaffForm" class="space-y-6" action="{{ route('add_employe.frontdesk') }}"
                        method="POST">
                        @csrf
                        <input type="text" name="hotel_id" id="hotel_id" class="hidden " placeholder="John"
                        ...
                        <div>
                            ...
                            <select id="role" name="role"
                                ...
                                <option value="Maintenance">Mainenance</option>
                                <option value="Food&Beverages">Kitchen</option>
