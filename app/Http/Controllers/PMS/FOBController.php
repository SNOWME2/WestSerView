...

{
    ...
    public function FOB_view()
    {
        return view('sub_views (PMS).pages.FOB.Dashboard');
    }
    ...
    public function foodAndBeveragesList()
    {
        $fobs = FOBList::paginate(20);
        return view('sub_views (PMS).pages.FOB.FOB_list', compact('fobs'));
    }
}